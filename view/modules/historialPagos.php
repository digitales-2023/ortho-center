      ...
      <main class="bg">
        <div class="container-fluid px-4">
          ...
          <div class="d-inline-flex m-2">
            <button type="button" class="btn btn-warning m-1" data-bs-toggle="modal" data-bs-target="#modalAgregarPago">
              Agregar Nuevo Pago
            </button>
            <button type="button" class="btn btn-success descargarPagos m-1" id="descargarPagos">
              Descargar Pagos
            </button>
          </div>
