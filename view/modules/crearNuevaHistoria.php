        ...
        <div class="container-fluid px-4">
          <h1 class="mt-4">
            <?php
              ...
              {
                $datosPaciente = ControllerPacientes::ctrMostrarDatosHistoria($codPaciente);
            ...
            <span class="border border-3 p-3">
              <div class="container row g-3">
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" id="sexoPaciente" name="sexoPaciente" value="<?php echo $datosPaciente["SexoPaciente"]?>">
                </div>
                
                <!-- Edad -->
                <div class="col-md-3">
                  <label for="edadPaciente" class="form-label" style="font-weight: bold">Edad: </label>
                  <input type="text" class="form-control" id="edadPaciente" name="edadPaciente" value="<?php echo $datosPaciente["EdadPaciente"]?>">
                </div>

                <!-- Lugar de nacimiento -->
                <div class="col-md-3">
                  <label for="lugarNacimiento" class="form-label" style="font-weight: bold">Lugar nacimiento: </label>
                  <input type="text" class="form-control" id="lugarNacimiento" name="lugarNacimiento" value="<?php echo $datosPaciente["LugarNacimiento"]?>">
                </div>

                <!-- Grado de instruccion -->
                <div class="col-md-3">
                  <label for="gradoInstruccion" class="form-label" style="font-weight: bold">Grado de instrucción: </label>
                  <input type="text" class="form-control" id="gradoInstruccion" name="gradoInstruccion" value="<?php echo $datosPaciente["GradoInstruccion"]?>">
                </div>

                <!-- Ocupación -->
                <div class="col-md-3">
                  <label for="ocupacionPaciente" class="form-label" style="font-weight: bold">Ocupación: </label>
                  <input type="text" class="form-control" id="ocupacionPaciente" name="ocupacionPaciente" value="<?php echo $datosPaciente["OcupacionPaciente"]?>">
                </div>

                <!-- Fecha Nacimiento -->
                <div class="col-md-3">
                  <label for="fechaNacimiento" class="form-label" style="font-weight: bold">Fecha de Nacimiento: </label>
                  <input type="date" class="form-control" id="fechaNacimiento" name="fechaNacimiento" value="<?php echo $datosPaciente["FechaNacimiento"]?>">
                </div>

                <!-- Raza -->
                <div class="col-md-3">
                  <label for="razaPaciente" class="form-label" style="font-weight: bold">Raza: </label>
                  <input type="text" class="form-control" id="razaPaciente" name="razaPaciente" value="<?php echo $datosPaciente["RazaPaciente"]?>">
                </div>

                <!-- Religión -->
                <div class="col-md-3">
                  <label for="religionPaciente" class="form-label" style="font-weight: bold">Religión: </label>
                  <input type="text" class="form-control" id="religionPaciente" name="religionPaciente" value="<?php echo $datosPaciente["ReligionPaciente"]?>">
                </div>

                <!-- Estado Civil -->
                <div class="col-md-3">
                  <label for="estadoCivil" class="form-label" style="font-weight: bold">Estado Civil: </label>
                  <input type="text" class="form-control" id="estadoCivil" name="estadoCivil" value="<?php echo $datosPaciente["EstadoCivil"]?>">
                </div>

                <!-- Lugar de procedencia -->
                <div class="col-md-3">
                  <label for="lugarProcedencia" class="form-label" style="font-weight: bold">Lugar de Procedencia: </label>
                  <input type="text" class="form-control" id="lugarProcedencia" name="lugarProcedencia" value="<?php echo $datosPaciente["LugarProcedencia"]?>">
                </div>

                <!-- Domicilio Actual -->
                <div class="col-md-3">
                  <label for="domicilioPaciente" class="form-label" style="font-weight: bold">Domicilio Actual: </label>
                  <input type="text" class="form-control" id="domicilioPaciente" name="domicilioPaciente" value="<?php echo $datosPaciente["DomicilioPaciente"]?>">
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" id="personaContacto" name="personaContacto" value="<?php echo $datosPaciente["NombreContactoPaciente"]?>">
                </div>

                <!-- Telefono Celular -->
                <div class="col-md-3">
                  <label for="numeroContacto" class="form-label" style="font-weight: bold">Número de Contacto: </label>
                  <input type="text" class="form-control" id="numeroContacto" name="numeroContacto" value="<?php echo $datosPaciente["NumeroContactoPaciente"]?>">
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="datatablesSimple" class="table table-striped dt-responsive tablaProcedimientos" width="100%">
          <thead>
            <tr>
