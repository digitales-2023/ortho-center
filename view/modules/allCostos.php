                    ...
                    foreach($listaCostos as $key => $value)
                    {
                      ...
                      if($value["EstadoCosto"] == "1")
                      {
                        ...
                        '<tr>
                          ...
                          <td>
                            <button title="Imprimir" class="btn btn-success btnImprimirGasto" id="btnImprimirGasto" codCosto="'.$value["IdCosto"].'"><i class="fa-solid fa fa-print"></i></button>
                            <button title="Finalizar" class="btn btn-primary btnFinalizarEstado" id="btnFinalizarEstado" codCosto="'.$value["IdCosto"].'"><i class="fa fa-check-circle"></i></button>
                            <button title="Editar" class="btn btn-warning btnEditarCosto" id="btnEditarCosto" codCosto="'.$value["IdCosto"].'"><i class="fa-solid fa-pencil"></i></button>
                            <button title="Eliminar" class="btn btn-danger btnEliminarCosto" codCosto="'.$value["IdCosto"].'"><i class="fa-solid fa-trash"></i></button>
                          </td>
                        </tr>';
                      }
                      else
