...
/**
 * ModelSocios — Nuevo módulo incorporado de dentavitalis (B)
 *
 * Maneja los registros en tba_socio (médicos y otros roles).
 */
class ModelSocios
{
  ...
  // Mostrar los tipos de socio (Ej: Médico, Asistente)
  ...
  // Mostrar los tipos de identificación (Ej: DNI, RUC)
  ...
  // Mostrar los socios para la cabecera de costos / gastos
  ...
  // Mostrar los socios agrupados por el tipo de socio
